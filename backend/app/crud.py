...
def get_recommendation(db: Session, uv_index: int, skin_tone: str, skin_type: str, activity_level: str) -> Optional[model.UVProtectionRecommendation]:
    return db.query(model.UVProtectionRecommendation).filter(
        and_(
